...
description: >-
  Use when a task needs current, multi-source web research and evidence-backed
  synthesis, including comparisons, landscape analyses, literature reviews, or
  research before producing fact-dependent content. Do not use for simple
  lookups, local repository investigation, or implementation work without an
...
This provides a systematic methodology for conducting thorough web research. **Read these instructions BEFORE starting any content generation task** to ensure you gather sufficient information from multiple angles, depths, and sources.
...
3. **Fetch Full Content**: Use web fetch to read important sources in full, not just snippets
