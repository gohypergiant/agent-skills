...
- `.agents/brainstorming/YYYY-MM-DD-feature-name.md` (Features)
- `.agents/brainstorming/YYYY-MM-DD-poc-name.md` (POCs)
- `.agents/brainstorming/YYYY-MM-DD-rfc-name.md` (RFCs)

## Next Steps

After brainstorming, proceed to:
- **Acceptance Planning** (`accelint-feature-acceptance-planning`) - Define requirements and acceptance criteria
- **Implementation Planning** (`accelint-feature-implementation-planning`) - Create executable tasks
- **Test Planning** (`accelint-feature-test-planning`) - Define test strategy
