...
- Action verbs: use clear action verbs so that the agent can map to test steps (such as "click", "fill", "select", "reload", "see"). Avoid vague verbs like "interact" or "use".
