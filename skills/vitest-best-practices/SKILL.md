...
- Refactoring existing `vitest` tests
- Reviewing `vitest` based tests for style
- Reviewing `vitest` based tests for correctness
- Reviewing `vitest` based tests for performance issues
