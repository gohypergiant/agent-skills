...
## Inputs: AC files
- metronome/skills/ac-to-playwright/artifacts/acceptance/sample-app-functionality.feature
- metronome/skills/ac-to-playwright/artifacts/acceptance/sample-app.feature
- metronome/skills/ac-to-playwright/artifacts/acceptance/sample-app.md

## Outputs: Playwright test files
- skills/ac-to-playwright/artifacts/tests/basic-functionality.spec.ts
- skills/ac-to-playwright/artifacts/tests/site-navigation.spec.ts
- skills/ac-to-playwright/artifacts/tests/sample-app.spec.ts
