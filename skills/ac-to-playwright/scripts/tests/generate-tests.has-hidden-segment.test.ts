...
describe("hasHiddenSegment", () => {
  it("returns false for normal paths", () => {
    expect(_hasHiddenSegment("skills/ac-to-playwright/artifacts/plans/a.json")).toBe(false);
    expect(_hasHiddenSegment("skills/ac-to-playwright/artifacts/plans/subdir/a.json")).toBe(false);
  });

  it("returns true for dotfiles", () => {
    expect(_hasHiddenSegment(".a.json")).toBe(true);
    expect(_hasHiddenSegment("skills/ac-to-playwright/artifacts/plans/.a.json")).toBe(true);
  });
  ...
  it("returns true for dot directories", () => {
    ...
    expect(_hasHiddenSegment("skills/ac-to-playwright/artifacts/plans/.hidden/a.json")).toBe(true);
    expect(_hasHiddenSegment("tests/.plans/.a.json")).toBe(true);
  });
  ...
  it("handles absolute paths", () => {
    expect(_hasHiddenSegment("/tmp/skills/ac-to-playwright/artifacts/plans/a.json")).toBe(false);
